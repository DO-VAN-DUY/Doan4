                                                      ...
                                                      <div class="col-lg-4 col-md-12 col-sm-4 col-xs-12 form-box text-center">
                                                                        ...
                                                                        <form action="" method="POST">
                                                                                          ...
                                                                                          <div class="form-input">
                                                                                                            ...
                                                                                                            <input type="name" placeholder="name" name="Tenkh" >
                                                                                          </div>
                                                                                          @if($errors->has('Tenkh'))
                                                                                          <strong class="text-dange" style="color: #fff">{{$errors->first('Tenkh')}}</strong>
                                                                                          @endif
                                                                                          <div class="form-input">
                                                                                                            <span><i class="fa fa-envelope"></i></span>
                                                                                                            <input type="address" placeholder="address" name="Diachi" >
                                                                                          </div>
                                                                                          @if($errors->has('Diachi'))
                                                                                          <strong class="text-dange" style="color: #fff">{{$errors->first('Diachi')}}</strong>
                                                                                          @endif
                                                                                          <div class="form-input">
                                                                                                            <span><i class="fa fa-envelope"></i></span>
                                                                                                            <input type="SDT" placeholder="sdt" name="SDT" >
                                                                                          </div>
                                                                                          @if($errors->has('SDT'))
                                                                                          <strong class="text-dange" style="color: #fff">{{$errors->first('SDT')}}</strong>
                                                                                          @endif
                                                                                          <div class="form-input">
                                                                                                            <span><i class="fa fa-envelope"></i></span>

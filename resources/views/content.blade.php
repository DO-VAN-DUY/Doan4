        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            <li><i class="ti-headphone-alt"></i> +0221 3713 15</li>
                            <li><i class="ti-email"></i> info@utehy.edu.vn</li>
                        </ul>
                    </div>
                    <!--/ End Top Left -->
                </div>
                <div class="col-lg-7 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            <li><i class="ti-alarm-clock"></i> <a href="#">Hoạt động</a></li>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="all-category">
                            <h3 class="cat-heading"><i class="fa fa-bars" aria-hidden="true"></i>DM Sản Phẩm</h3>
                            ...
                            <nav class="navbar navbar-expand-lg">
                                <div class="navbar-collapse">
                                    ...
                                    <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            {{-- <li><a href="#">Diễn đàm<i class="ti-angle-down"></i></a>
                                                <ul class="dropdown">

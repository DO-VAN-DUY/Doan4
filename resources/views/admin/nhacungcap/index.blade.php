...
<div class="container-fluid px-4" ng-controller="mycontrol">
                        <p>
                                    ...
                                    <div class="modal-body">
                                        <div class="container-fluid">
                                            <div class="form-group">
                                                <label for="tenncc">Ten NCC</label>
                                                <div><input type="text" ng-model="n.Tenncc" class="form-control"></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="tenncc">Dia chi</label>
                                                <div><input type="text" ng-model="n.Diachi" class="form-control"></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="tenncc">Email</label>
                                            <div><input type="text" ng-model="n.Email" class="form-control"></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="tenncc">Phone</label>
                                                <div><input type="text" ng-model="n.Dienthoai" class="form-control"></div>
                                            </div>
                                        </div>
